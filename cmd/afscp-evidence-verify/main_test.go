...
var package0CLIMetadata = []struct {
	...
	{"default_user_loop_jvs_save_restore_unit", "CLAIM_DEFAULT_USER_LOOP", "default_user_loop_jvs_save_restore", "P1C_DEFAULT_USER_LOOP_JVS_SAVE_RESTORE", "F2", "positive", "fast", "package", "true", "positive_path", "JVS save history and direct restore paths pass without closing the full default user loop"},
