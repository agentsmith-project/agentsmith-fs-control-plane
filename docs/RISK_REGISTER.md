...
| R-002 | JVS runner behavior differs from AFSCP assumptions | high | yes | AFSCP maintainer | auto_verified | closed by v0.4.8 repo-local evidence | `scripts/verify-ga-release.sh`, `docs/JVS_SMOKE_EVIDENCE_2026-05-05-v0.4.8.md`, `docs/contracts/jvs-runner-contract-v1.md`, JVS runner tests | JVS v0.4.8 release binary/checksum pinned; restore-run recovery plan residual blocker resolved; runner contract updated with CWD/argv rule |
