...
| R-002 | JVS runner behavior differs from AFSCP assumptions | high | yes | AFSCP maintainer | auto_verified | closed by published direct-capable JVS release pin and runner contract evidence | `scripts/verify-ga-release.sh`, `docs/JVS_AFSCP_DIRECT_RELEASE_EVIDENCE_2026-05-18.md`, `docs/contracts/jvs-runner-contract-v1.md`, JVS runner tests | JVS `v0.4.10` release binary/checksum/source ref pinned; future JVS changes require a new published release pin |
