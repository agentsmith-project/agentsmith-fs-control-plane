...
| R-002 | JVS runner behavior differs from AFSCP assumptions | high | yes | AFSCP maintainer | auto_verified | closed for pre-GA by local direct-capable pin and runner contract evidence | `scripts/verify-ga-release.sh`, `docs/JVS_AFSCP_DIRECT_LOCAL_EVIDENCE_2026-05-16.md`, `docs/contracts/jvs-runner-contract-v1.md`, JVS runner tests | Pre-GA direct local binary/checksum/source ref pinned; formal JVS release checksum remains required before GA/release packaging |
