...
| G-005 | JVS runner pin and direct contract evidence | auto_verified | AFSCP maintainer | `scripts/verify-ga-release.sh`, `docs/adr/0009-jvs-runner-pin.md`, `docs/JVS_AFSCP_DIRECT_LOCAL_EVIDENCE_2026-05-16.md`, `docs/contracts/jvs-runner-contract-v1.md`, JVS runner tests | Pre-GA local direct-capable JVS pin, JVS binary artifact SHA-256, source ref, and `jvs afscp` command expectations are recorded | Historical v0.4.8/v0.4.9 evidence is retained as context only; formal release provenance remains a pre-GA follow-up |
