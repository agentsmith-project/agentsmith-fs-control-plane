...
| G-003 | Schemas and OpenAPI | in_review | AFSCP maintainer | Calling product owner, operator/tooling owner | `api/schemas/afscp-internal-v1.schema.json`, `api/openapi/internal-v1.openapi.yaml` | first machine contract draft exists | 2026-05-05 | Generated client review still required |
...
| G-005 | JVS runner pin and smoke evidence | blocked | AFSCP maintainer | JVS owner | `docs/adr/0009-jvs-runner-pin.md`, `docs/JVS_SMOKE_EVIDENCE_2026-05-05.md` | JVS release binary pinned, smoke blocker found | 2026-05-05 | Blocks storage mutations until JVS restore-plan behavior is resolved |
| G-006 | Path resolver contract and corpus | in_review | AFSCP maintainer | Security owner | `docs/adr/0012-path-resolver-and-fences.md`, `docs/contracts/repo-path-contract-v1.md` | resolver rules accepted for handoff | 2026-05-05 | Test corpus still to implement |
...
| G-009 | Writer-session fence contract | in_review | AFSCP maintainer | Operations owner, orchestrator owner, client connector owner | `docs/adr/0012-path-resolver-and-fences.md`, `docs/contracts/operation-state-machine-v1.md` | writer fence and lifecycle fence drafted | 2026-05-05 | Tests still to implement |
