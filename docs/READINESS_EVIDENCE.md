...
without a matching end delta. JVS save/restore/template handlers, workload
mount issuance, non-HTTP audit sinks, and other external integrations remain
incomplete.
