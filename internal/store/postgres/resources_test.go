...
func bindingFixture() resources.NamespaceVolumeBinding {
	...
	return resources.NamespaceVolumeBinding{
		...
		AllowedCallers:    []resources.AllowedCaller{{CallerService: "agentsmith-api", Roles: []resources.CallerRole{resources.CallerRoleRepoAdmin, resources.CallerRoleOperationInspector}}},
